...
import { Home, Calendar, User, Apple, Carrot, Sandwich } from 'lucide-react'

export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-orange-400 to-red-500 text-white p-4 fixed bottom-0 left-0 right-0 shadow-lg z-10">
